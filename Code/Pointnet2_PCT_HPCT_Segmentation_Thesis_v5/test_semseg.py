...
def main(args):
    ...
    file_handler = logging.FileHandler('%s/eval-bfge.txt' % experiment_dir)
    file_handler.setLevel(logging.INFO)
    file_handler.setFormatter(formatter)
    logger.addHandler(file_handler)
    log_string(f'Model is: {args.log_dir}')
    log_string('PARAMETER is as follows: ')
    log_string(args)
